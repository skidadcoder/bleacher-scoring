      ...
      <SafeAreaView style={[GlobalStyles.screenRootView]}>
        ...
        <ScrollView style={[{ margin: 10 }]}>
          <Text style={[styles.text]}>
            Bleacher Technologies built the Bleacher Scoring app as a Freemium app. This SERVICE is provided by Bleacher
            Technologies at no cost and is intended for use as is.
          </Text>
          <Text style={[styles.text]}>
          ...
          <Text style={[styles.text]}>
            ...
            accessible at Bleacher Scoring unless otherwise defined in this Privacy Policy.
          </Text>
          <Text style={[styles.text, styles.header]}>Information Collection and Use</Text>
          <Text style={[styles.text]}>
            For a better experience, while using our Service, we may require you to provide us with certain personally
            identifiable information, including but not limited to Full name, email address, display name, telephone
            number. The information that we request will be retained by us and used as described in this privacy policy.
          </Text>
          <Text style={[styles.text]}>
          ...
          <TouchableOpacity
            onPress={() => {
              Linking.openURL("https://www.google.com/policies/privacy/").catch(err =>
                console.error("An error occurred", err)
              );
            }}
          >
            <Text style={[styles.text, { marginLeft: 10, color: Colors.secondaryColor }]}>
              {"\u2022" + " Google Play Services"}
            </Text>
          </TouchableOpacity>

          <Text style={[styles.text, styles.header]}>Log Data</Text>
          <Text style={[styles.text]}>
          ...
          <Text style={[styles.text, styles.header]}>Cookies</Text>
          <Text style={[styles.text]}>
          ...
          <Text style={[styles.text, styles.header]}>Service Providers</Text>
          <Text style={[styles.text]}>
            We may employ third-party companies and individuals due to the following reasons:
          </Text>
          <Text style={[styles.text, { marginLeft: 10 }]}>{"\u2022" + " To facilitate our Service;"}</Text>
          <Text style={[styles.text, { marginLeft: 10 }]}>{"\u2022" + " To provide the Service on our behalf;"}</Text>
          <Text style={[styles.text, { marginLeft: 10 }]}>{"\u2022" + " To perform Service-related services; or"}</Text>
          ...
          <Text style={[styles.text, styles.header]}>Security</Text>
          <Text style={[styles.text]}>
          ...
          <Text style={[styles.text, styles.header]}>Links to Other Sites</Text>
          <Text style={[styles.text]}>
          ...
          <Text style={[styles.text, styles.header]}>Children’s Privacy</Text>
          <Text style={[styles.text]}>
          ...
          <Text style={[styles.text, styles.header]}>Changes to This Privacy Policy</Text>
          <Text style={[styles.text]}>
